                    ...
                    <div className="p-4 lg:w-1/2 md:w-full">
                        <div className="flex flex-col w-full h-full p-8 bg-white rounded-lg shadow-lg sm:flex-row">
                            <div className="">
                                ...
                                <h2 className="font-medium text-gray-900 text-md">Date: {date}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Origin: {origins}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Region: {region}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Artist: {artist}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Route: {route}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Host Museum: {hostMuseum}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Object Type: {objectType}</h2>
                                <h2 className="font-medium text-gray-900 text-md">Specifications: {specifications}</h2>
                                <p className="text-base leading-relaxed">{description}</p>
                                <Button onClick={() => play(audio)} variant="ghost">
